...
| `npm run selftest` | the in-page suite, 338 assertions against a live DOM in a real browser, no-helper mode, against a production build the job serves itself |
...
The in-page job asserts three numbers — `334/338 passed · 0 failed · 4 not run
